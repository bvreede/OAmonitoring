...
id_column <- 'ID-1'
title_column <- 'Title of the contribution in original language-2'
issn_column <- 'Journal > ISSN-5'
doi_column <- 'Electronic version(s) of this work > DOI (Digital Object Identifier)-6'
